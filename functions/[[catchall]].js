export async function onRequest(context) {
  ...
  // Skip API routes, static assets, and frontend app routes
  ...
  try {
    console.log('Public redirect request:', { username, slug, source });
