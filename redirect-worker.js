...
export default {
  async fetch(request, env, ctx) {
    ...
    console.log('Parsed values:', { username, slug, public_code });
    
    try {
      console.log('Redirect request:', { username, slug, public_code });
      ...
      if (public_code) {
        console.log('Looking up placement by public_code:', public_code, 'for link_id:', link.id);
        ...
        if (placement) {
          ...
          if (placementBySourceCode) {
            ...
            source = public_code;
            console.log('Placement not found by either public_code or source_code, using public_code as source:', source);
          }
        }
      }
