    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-900 border border-gray-800 rounded-lg max-w-md w-full">
        <div className="flex items-center justify-between p-4 border-b border-gray-800">
          <h2 className="text-lg font-semibold text-white">Add Placement</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <div>
            ...
            <input
              ...
              maxLength={50}
            />
            <p className="mt-1 text-xs text-gray-500">Custom label to identify this placement</p>
          </div>
          ...
          <div>
            ...
            />
            <p className="mt-1 text-xs text-gray-500">Unique identifier for tracking (auto-generated by default)</p>
          </div>
